export const en = {
  ...
  testimonials: {
    ...
    description: "Discover why our guests keep coming back to MakiSereno for their seaside getaways."
  },
  notFound: {
  ...
  home: {
    welcome: {
      subtitle: "Welcome to MakiSereno",
      title: "Luxury Seaside Accommodations",
      description1: "Nestled on the pristine Mediterranean coastline, MakiSereno offers an exquisite collection of luxury apartments and hotel rooms. Our beachfront accommodations combine elegant design with modern comfort, creating the perfect setting for an unforgettable seaside getaway.",
  ...
  amenitiesPage: {
    ...
    description: "At MakiSereno, we are dedicated to providing a comprehensive and luxurious stay experience. From our beachfront services to wellness facilities, every detail has been curated to ensure maximum comfort and pleasure.",
    categories: {
      wellness: {
